		...
		<div class="container" id="wrapper">
			...
			<section dir="rtl" id="content" class="col-lg-7">
				...
				<div class="content-bg" style="background: #99c6df;">
					<div id="desc">
                                            <h2 class="entry-title">هيا نتعلم هنا طريقة تعريف المتغير واعطائه قيمة .....</br>انطلق.....</br>
                                                </br>من هنا بأمكانك إختيار الإجابة بحسب ترتيبها الصحيح </h2>
						<br />
						<div id="X" align="center">
							<div id="yes-drop" name="3-" class="draggable drag-drop">int</div>
							<div id="yes-drop" name="1-" class="draggable drag-drop">;25</div>
...
interact('.dropzone').dropzone({
  ...
  ondrop: function (event) {
	...
	&& document.getElementsByName('3-')[0].style.backgroundColor == 'green'
		...
		document.getElementById('desc').innerHTML = '<br /><h2 style="color:red">ممتاز ..<br /></br> عرفت المتغير X من نوع int واعطيته قيمة 25</br></br> ;int X= 25</br><br />بإمكانك المتابعة للمرحلة التالية</h2><br />';
		document.getElementById('buttons').innerHTML += '<a href="game.php?l=3&g=3" class="button green pull-left"><span>&#xf137;</span> التالي</a>';
