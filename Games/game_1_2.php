		...
		<div class="container" id="wrapper">
			...
			<section dir="rtl" id="content" class="col-lg-7">
				...
				<div class="content-bg" style="background: #99c6df;">
					<div id="desc">
                                            <h2 class="entry-title">هنا نتعلم أمر الطباعة في لغة الجافا</br> 
                                                
                                                استمر...</br>
                                                من هنا بأمكانك إختيار الإجابة بحسب ترتيبها الصحيح</h2>
						<br />
						<div id="X" align="center">
							<div id="yes-drop" name="2-" class="draggable drag-drop"> .out</div>
							<div id="yes-drop" name="3-" class="draggable drag-drop">.System</div>
                                                        <div id="yes-drop" name="1-" class="draggable drag-drop" dir="ltr">println( );</div>
...
interact('.dropzone').dropzone({
  ...
  ondrop: function (event) {
	...
	&& document.getElementsByName('3-')[0].style.backgroundColor == 'green'
		...
		document.getElementById('desc').innerHTML = '<br /><h2 style="color:red">أحسنت ..<br /></br> لقد استطعت ترتيب كود الطباعة بشكل رائع</br><br /> ;( )system.out.println</br></br> بإمكانك المتابعة للمرحلة التالية</h2><br />';
		document.getElementById('buttons').innerHTML += '<a href="game.php?l=1&g=3" class="button green pull-left"><span>&#xf137;</span> التالي</a>';
