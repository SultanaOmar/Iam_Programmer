...
<head>
	...
	<body>
		<div class="container" id="wrapper">
				...
				<section dir="rtl" id="content" class="col-lg-7">
					...
					<div class="content-bg">
						...
						<div id="X" align="center">
							<div id="1" class="drag-drop-box">طباعة الكلمة التالي:<br />!Hello World</div><br />
							<br />
						</div>
					</div>
				</section>
			...
			<section dir="rtl" id="content" class="col-lg-7">
				...
				<div class="content-bg" style="background: #99c6df;">
					<div id="desc">
                                            <h2 class="entry-title">بعد ان تعلمت أمر الطباعة، الان ابدأ بكتابة الكود الذي ينفذ هذا الأمر
                                                </br>
                                                </br> جهة الكتابة | أكمل الكود التالي للإخراج المطلوب في القائمة ب</h2>
						<br />
		...
		function send() {
			...
			var r_ans = 'system.out.println("hello world!");';
			
			if(res.indexOf(r_ans) !== -1) {
				document.getElementById('send').remove();
				document.getElementById('viewer').remove();
				document.getElementById('desc').innerHTML = '<br /><h2 style="color:red">أحسنت أيهاالمبرمج الصغير ..<br /></br> استطعت بذكاء ان تنفذ المطلوب </br></br>(;"!system.out.println("Hello World</br></br><br />بإمكانك المتابعة للمرحلة التالية</h2><br />';
				document.getElementById('buttons').innerHTML += '<a href="Description2.php" class="button green pull-left"><span>&#xf137;</span> التالي</a>';
